...
<<<<<<< HEAD
        ...
        //public string bPath = @"E:\College\Sarathi\Test Images\B test";
        //public string cPath = @"E:\College\Sarathi\Test Images\C test";
        //public string dPath = @"E:\College\Sarathi\Test Images\D test";
...
<<<<<<< HEAD
        ...
        private void resizeOnlyToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Bitmap src = new Bitmap(pictureBox1.Image);
            Bitmap res = new Bitmap(pictureBox2.Image);
            src = resize(src, new Size(200, 200));
        ...
        private void singleFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FileStream fs = new FileStream(@"C:\AI.txt", FileMode.Append, FileAccess.Write);
                ...
                Problem train = Problem.Read(@"C:\AI.txt");
                Problem test = Problem.Read(@"C:\test.txt");
        ...
        private void multipleFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            string basePath;
            string[] file = null;
            ...
            if (folderDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                int no = 1;
                string[] table = Directory.GetDirectories(basePath);
                foreach (string path in table)
                {
                    file = Directory.GetFiles(path, "*.jpg", SearchOption.TopDirectoryOnly);
                    foreach (string f in file)
                    {

                        Bitmap src = new Bitmap(f);
                        Bitmap res = new Bitmap(f);
                        SaveFileDialog saveDialog = new SaveFileDialog();
                        src = resize(src, new Size(200, 200));
                        res = resize(res, new Size(200, 200));
                        pictureBox1.Image = src;
